...
namespace ApiFaktum.Controllers
{
    ...
    public class ResolucionController : ControllerBase
    {
        ...
        /// <returns></returns>
        public ResolucionController(IResolucionService _objService, ICreateLogger _createLogger, IValidacionesService _objValidacionesService)
        {
        ...
        /// <returns>Task<Result></returns>
        [HttpGet]
        [Route("ConsultarResolucionId")]
        public async Task<IActionResult> ConsultarResolucionId(int idResolucion)
        {
            Result oRespuesta = new();

            try
            {
                var vRespuesta = await objService.ConsultarResolucionId(idResolucion);
