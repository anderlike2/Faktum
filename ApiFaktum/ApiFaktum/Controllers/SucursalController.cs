...
namespace ApiFaktum.Controllers
{
    ...
    public class SucursalController : ControllerBase
    {
        ...
        /// <returns></returns>
        public SucursalController(ISucursalService _objService, ICreateLogger _createLogger, IValidacionesService _objValidacionesService)
        {
        ...
        /// <returns>Task<Result></returns>
        [HttpGet]
        [Route("ConsultarSucursalId")]
        public async Task<IActionResult> ConsultarSucursalId(int idSucursal)
        {
            Result oRespuesta = new();

            try
            {
                var vRespuesta = await objService.ConsultarSucursalId(idSucursal);
