...
namespace DependencyInjection
{
    public static class InyectarDependencia
    {
        ...
        public static void InyeccionServicios(this IServiceCollection services, IConfiguration Configuration)
        {
            ...
            services.AddScoped(typeof(ICupRepository), typeof(CupRepository));
            ...
            services.AddScoped(typeof(IResolucionSucursalService), typeof(ResolucionSucursalService));
            services.AddScoped(typeof(IUsuarioSaludRipsService), typeof(UsuarioSaludRipsService));
            services.AddScoped(typeof(IConsultaRipsService), typeof(ConsultaRipsService));
            services.AddScoped(typeof(IProcedimientoRipsService), typeof(ProcedimientoRipsService));
            services.AddScoped(typeof(IMedicamentosRipsService), typeof(MedicamentosRipsService));
            services.AddScoped(typeof(IUrgenciaRipsService), typeof(UrgenciaRipsService));
