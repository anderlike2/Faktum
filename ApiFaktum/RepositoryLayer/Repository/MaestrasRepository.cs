...
namespace RepositoryLayer.Repository
{
    ...
    public class MaestrasRepository : IMaestrasRepository
    {
                ...
                switch (tipoClase)
                {
                    case Constantes.claseFactura:
                        ...
                        foreach (var item in r1)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.ClfaCodigo, item.ClfaNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.tipoCliente:
                        var r2 = await objContext.Set<TipoClienteModel>().Where(x => x.Estado == 1).ToListAsync();
                        foreach (var item in r2)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.TiclCodigo, item.TiclNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.tipoCups:
                        var r3 = await objContext.Set<TipoCupModel>().Where(x => x.Estado == 1).ToListAsync();
                        foreach (var item in r3)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.TicuCodigo, item.TicuNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.tipoDocElectr:
                        ...
                        foreach (var item in r4)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.TidoCodigo, item.TidoNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.moneda:
                        var r5 = await objContext.Set<MonedaModel>().Where(x => x.Estado == 1).ToListAsync();
                        foreach (var item in r5)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.MoneCodigo, item.MoneNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.tipoId:
                        var r6 = await objContext.Set<TipoIdModel>().Where(x => x.Estado == 1).ToListAsync();
                        foreach (var item in r6)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.TiidCodigo, item.TiidNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.tipoDescuento:
                        ...
                        foreach (var item in r7)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.TideCodigo, item.TideNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.tipoArchivoRips:
                        ...
                        foreach (var item in r8)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.ArriCodigo, item.ArriNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.respTributaria:
                        ...
                        foreach (var item in r9)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.RetrCodigo, item.RetrNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.respFiscal:
                        ...
                        foreach (var item in r10)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.RefiCodigo, item.RefiNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.formaPago:
                        ...
                        foreach (var item in r11)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.FopaCodigo, item.FopaNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.factSaludTipo:
                        ...
                        foreach (var item in r12)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.FasaCodigo, item.FasaNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.estadoDianFactura:
                        ...
                        foreach (var item in r13)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.EsfaCodigo, item.EsfaNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.cups:
                        var r14 = await objContext.Set<CupModel>().Where(x => x.Estado == 1).ToListAsync();
                        foreach (var item in r14)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.CupsCodigo, item.CupsNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.condicionVenta:
                        ...
                        foreach (var item in r15)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.CoveCodigo, item.CoveNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.pais:
                        var r16 = await objContext.Set<PaisModel>().Where(x => x.Estado == 1).ToListAsync();
                        foreach (var item in r16)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.PaisCodigo, item.PaisNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.modalidadPago:
                        ...
                        foreach (var item in r17)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.MopaCodigo, item.MopaNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
                    case Constantes.conceptoNotas:
                        ...
                        foreach (var item in r18)
                            lstRespuesta.Add(FormarRespuestaMaestra(item.Id, item.ConoCodigo, item.ConoNombre, item.Estado, item.FechaCreacion, item.FechaModificacion));
                        break;
        ...
        /// <returns>Task<Result></returns>
        public MaestraDto FormarRespuestaMaestra(int id, string? codigo, string? nombre, int estado, DateTime? fechaCreacion, DateTime? fechaModificacion)
        {
