...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'gestion-resolucion-sucursal',
        loadChildren: () => import('./pages/gestion-resolucion-sucursal/gestion-resolucion-sucursal.module').then(m => m.GestionResolucionSucursalModule),
        canActivate: [LoginGuard]
      },
      {
        path: 'home',
